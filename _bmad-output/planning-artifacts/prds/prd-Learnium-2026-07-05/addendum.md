...
- Stack: Next.js 15 (App Router) + Supabase (auth/Postgres) + Stripe, with a separate Python/FastAPI RAG microservice (`rag/`) using LangChain, Chroma, OpenAI SDK, and Redis LangCache for semantic response caching.
